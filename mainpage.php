...
<div class="header">
  <h1>EASY MEDS</h1>
 <p style="margin-top:-20px;line-height:1;font-size:30px;">SAKEC MINI PROJECT - Medical Store Management System</p>
 <p style="margin-top:-20px;line-height:1;font-size:20px;">Department of Computer Engineering</p>
</div>
<title>
...
<body>
	...
	<div class=footer>
	<br>
	Developed by sumeet , shiven, preet, vatsal
	<br><br>
	</div>
